...
output_dir = '/home/anikait.singh/personalized-t2i/outputs'
...
def main(_):
    ...
    for user in unique_users:
        ...
        question += f"\n\nWhat brings together the preferred images and what sets them apart from the dispreferred images according to the style, visual quality, and image aesthetics? Summarize this into a user profile."
